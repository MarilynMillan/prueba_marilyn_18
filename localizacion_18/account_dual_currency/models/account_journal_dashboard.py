...
class account_journal(models.Model):
    ...
    def _fill_sale_purchase_dashboard_data(self, dashboard_data):
        ...
        payment_field_list = [
            ...
            "-account_move_line.amount_residual_usd AS amount_total_company",
        ]
        # DRAFTS
        ...
        for journal in sale_purchase_journals:
            ...
            dashboard_data[journal.id].update({
                ...
                'sum_draft': currency.format(sum_draft * (currency_id_dif.inverse_company_rate)),
                'sum_draft_usd': currency_id_dif.format(sum_draft),

                'sum_waiting': currency.format(sum_waiting * ( currency_id_dif.inverse_company_rate)),
                'sum_waiting_usd': formatLang(self.env, currency_id_dif.round(sum_waiting) + 0.0,
                                              currency_obj=currency_id_dif),

                'sum_late': currency.format(sum_late * ( currency_id_dif.inverse_company_rate)),
