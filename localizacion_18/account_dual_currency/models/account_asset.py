...
class AccountAsset(models.Model):
    ...
    tax_today = fields.Float(string='Tasa de Cambio', required=True, default=lambda self: self.env.company.currency_id_dif.inverse_company_rate, digits='Dual_Currency_rate')
